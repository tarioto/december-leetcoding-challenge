...
test('maxDepth of [1 ,2, 3, 4, 5, null, null, null, null, 6, null] to equal 4', () => {
  const root = new TreeNode(1, new TreeNode(3, undefined, undefined), new TreeNode(2, new TreeNode(undefined, undefined), new TreeNode(5, new TreeNode(6, undefined, undefined), undefined)))
  expect(maxDepth(root)).toBe(4);
});

test('maxDepth of [1, null, 2] to equal 2', () => {
  const root = new TreeNode(1, undefined, new TreeNode(2))
