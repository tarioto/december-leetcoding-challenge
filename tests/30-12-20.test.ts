import { pseudoPalindromicPaths, isValid, aux, TreeNode } from "../problems/30-12-20";
...
test('pseudoPalindromicPaths of [2,1,1,1,3,null,null,null,null,null,1] to equal 1', () => {
  const root = new TreeNode(2, new TreeNode(1, new TreeNode(1, null, null), new TreeNode(3, null, 1)), new TreeNode(1, null, null))
